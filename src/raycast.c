...
CUDA_DEV RaycastResult cube_raycast(vec3 origin, vec3 direction, int object_index, cube cube) {
    // front
    // back
    // top
    // bottom
...
CUDA_DEV RaycastResult raycast(vec3 origin, vec3 direction, int num_objects, BasePart *objects, int ignore_object_index) {
    RaycastResult result;
